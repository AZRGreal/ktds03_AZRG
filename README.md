...
|     | 내용 |
|-----|------|
| 🎯  | 지하철역 주변의 음식점/카페를 쉽고 빠르게 검색하고,  
         각 음식점의 리뷰 요약 및 YouTube 영상(제목/설명/자막/댓글 최대 500개) 기반 장·단점 자동 분석 기능 제공 |
...
|     | 내용 |
|-----|------|
| 🎯  | 지하철역 주변의 음식점/카페를 쉽고 빠르게 검색하고, 각 음식점의 리뷰 요약 및 YouTube 영상(제목/설명/자막/댓글 최대 500개) 기반 장·단점 자동 분석 기능 제공 |
| ☁️  | Azure 환경 기반 다양한 기능 활용 (Streamlit 웹앱)으로 사용자 편의성과 인사이트 제공 |
...
|     | 내용 |
|-----|------|
| 👨‍💼 | 회사원·매장운영자·일반사용자 등 누구나 "점심/저녁 뭐 먹지?" 고민 해결! |
| 💡  | "막내야, 맛집 좀 찾아봐!"라는 요청에 칭찬도 받고 시간도 아끼고자 제작 |
| 🗺️  | 지하철 상권, 리뷰/평판/이슈를 한눈에 파악하고 싶다! |
| 🤖  | Google Maps, Azure, GPT 등 AI & 클라우드 연계로 효율적이고 정확한 정보 습득 |
| 🎥  | YouTube 영상 데이터는 실제 후기, 생생한 트렌드를 가장 잘 반영! (네이버/다음 대비) |
| 📝  | GPT가 대량의 리뷰/댓글도 빠르게 요약해서 시간 절약 |
| 🖱️  | 노코드/로우코드 환경에서 누구나 쉽게 사용 가능 (Streamlit 웹 UI) |
...
- 유튜브 영상 다운로드/음성 분석까지 하고 싶었으나  
  **Azure 환경에서 영상 다운로드 기능(yt-dlp 등)이 막힘**  
